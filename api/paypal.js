...
function getPayPalEnvironment() {
  return String(process.env.PAYPAL_ENVIRONMENT || process.env.VITE_PAYPAL_ENVIRONMENT || 'live').toLowerCase();
}
...
function getPayPalCredentials() {
  ...
  const secret = process.env.PAYPAL_CLIENT_SECRET || process.env.PAYPAL_SECRET || process.env.VITE_PAYPAL_SECRET || '';
