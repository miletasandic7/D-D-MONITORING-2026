              ...
              {!globalSearchNeedle && (
                <div style={{ marginBottom: '2rem' }}>
                  <div style={{ 
                    ...
                    <div style={{ flex: 1 }}>
                      <h4 style={{ color: '#00d4ff', margin: 0, fontSize: '1rem' }}>Live Public Cameras - Demo</h4>
                      <p style={{ color: '#8ab0c9', margin: 0, fontSize: '.8rem' }}>Real live streams from around the world</p>
                    </div>
                    <a 
                      href="/cameras" 
                      style={{
                  ...
                  <div style={{ 
                    ...
                    {[
                      { name: 'Times Square NYC', location: 'New York, USA', img: 'https://images.webcams.travel/preview/1203281713.jpg' },
                      { name: 'Las Vegas Strip', location: 'Las Vegas, NV', img: 'https://cdn.cnn.com/cnnnext/dam/assets/200923092008-vegas-cam.jpg' },
                      { name: 'Shibuya Tokyo', location: 'Tokyo, Japan', img: 'https://tokyo-g.jp/cdn/webcam.jpg' },
                      { name: 'London Eye', location: 'London, UK', img: 'https://cdn.london24.it/files/live-webcam-london.jpg' }
                    ].map((pub, i) => (
                      <div 
                        key={i}
                        style={{
                      ...
                      >
                        ...
                        <div style={{ padding: '.75rem' }}>
                          <h5 style={{ color: '#dff7ff', margin: 0, fontSize: '.9rem' }}>📹 {pub.name}</h5>
                          <p style={{ color: '#6a8aaa', margin: '.25rem 0 0', fontSize: '.75rem' }}>📍 {pub.location}</p>
                        </div>
                      </div>
                    ))}
                  </div>
